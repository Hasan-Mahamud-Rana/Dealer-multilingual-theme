...
function slider_scripts() {
  wp_enqueue_style( 'slick-stylesheet', get_template_directory_uri() .'/assets/slider/slick.css' );
  wp_enqueue_style( 'slick-theme-stylesheet', get_template_directory_uri() .'/assets/slider/slick-theme.css' );
  wp_enqueue_style( 'slick-lightbox-stylesheet', get_template_directory_uri() .'/assets/slider/slick-lightbox.css' );
 }
