...
function joints_register_sidebars() {
	register_sidebar(array(
		...
		'after_widget' => '</div>',
		'before_title' => '<h4 class="swidgettitle">',
		'after_title' => '</h4>',
	));
	...
	register_sidebar(array(
		...
		'before_widget' => '<div id="%1$s" class="small-12 medium-4 small-centered large-uncentered large-4 columns widget %2$s"><div class="widget_bg" data-equalizer-watch>',
